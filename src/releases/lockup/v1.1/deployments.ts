...
export const mainnets: Sablier.DeploymentLockupV1[] = [
  get(ChainId.ETHEREUM, {
    core: {
      ...
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0x7CC7e125d83A581ff438608490Cc0f7bDff79127",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0xAFb979d9afAd1aD27C5eFf4E27226E3AB9e5dCC9",
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_MERKLE_STREAMER_FACTORY]: "0x1A272b596b10f02931480BC7a3617db4a8d154E3",
    },
  }),
  get(ChainId.ARBITRUM_ONE, {
    core: {
      [manifest.core.SABLIER_V2_COMPTROLLER]: "0x17Ec73692F0aDf7E7C554822FBEAACB4BE781762",
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0xf390cE6f54e4dc7C5A5f7f8689062b7591F7111d",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0xFDD9d122B451F549f48c4942c6fa6646D849e8C1",
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_MERKLE_STREAMER_FACTORY]: "0x237400eF5a41886a75B0e036228221Df075b3B80",
    },
  }),
  get(ChainId.AVALANCHE, {
    core: {
      [manifest.core.SABLIER_V2_COMPTROLLER]: "0x66F5431B0765D984f82A4fc4551b2c9ccF7eAC9C",
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0x0310Da0D8fF141166eD47548f00c96464880781F",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0xB24B65E015620455bB41deAAd4e1902f1Be9805f",
  ...
  get(ChainId.BASE, {
    core: {
      ...
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0x461E13056a3a3265CEF4c593F01b2e960755dE91",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0xFCF737582d167c7D20A336532eb8BCcA8CF8e350",
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_MERKLE_STREAMER_FACTORY]: "0x5545c8E7c3E1F74aDc98e518F2E8D23A002C4412",
    },
  }),
  get(ChainId.BERACHAIN, {
    core: {
      [manifest.core.SABLIER_V2_COMPTROLLER]: "0x1F11d838B4938959aA131e4C784C9d91c1df2a1B",
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0x1774629dBAc6fAad3aF535a074F4e8399F4f063B",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0xF2B2CCA6b8062996F5B5B7E97e0BC821F1266dBC",
      [manifest.core.SABLIER_V2_NFT_DESCRIPTOR]: "0x5fA051E255AD309F68CA3588E30225d4f0A616bd",
    },
    periphery: {
      [manifest.periphery.SABLIER_V2_BATCH]: "0x0dF5C6fDebEdCdb6ae8733ed54460dba4756605F",
      [manifest.periphery.SABLIER_V2_MERKLE_STREAMER_FACTORY]: "0x7A34159cf99F0E04596B7C93C96ff390D806E3bE",
    },
  }),
  get(ChainId.BLAST, {
    core: {
      [manifest.core.SABLIER_V2_COMPTROLLER]: "0x2De92156000269fa2fde7544F10f01E8cBC80fFa",
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0xDf578C2c70A86945999c65961417057363530a1c",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0xcb099EfC90e88690e287259410B9AE63e1658CC6",
      [manifest.core.SABLIER_V2_NFT_DESCRIPTOR]: "0x67e0a126b695DBA35128860cd61926B90C420Ceb",
    },
    periphery: {
      [manifest.periphery.SABLIER_V2_BATCH]: "0x0eDA15D606733f6CDe9DB67263E546bfcDDe9264",
      [manifest.periphery.SABLIER_V2_MERKLE_STREAMER_FACTORY]: "0x92FC05e49c27884d554D98a5C01Ff0894a9DC29a",
    },
  }),
  get(ChainId.BSC, {
    core: {
      [manifest.core.SABLIER_V2_COMPTROLLER]: "0x33511f69A784Fd958E6713aCaC7c9dCF1A5578E8",
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0xf900c5E3aA95B59Cc976e6bc9c0998618729a5fa",
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_MERKLE_STREAMER_FACTORY]: "0x434D73465aAc4125d204A6637eB6C579d8D69f48",
    },
  }),
  get(ChainId.GNOSIS, {
    core: {
      [manifest.core.SABLIER_V2_COMPTROLLER]: "0x73962c44c0fB4cC5e4545FB91732a5c5e87F55C2",
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0x1DF83C7682080B0f0c26a20C6C9CB8623e0Df24E",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0xce49854a647a1723e8Fb7CC3D190CAB29A44aB48",
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_MERKLE_STREAMER_FACTORY]: "0x777F66477FF83aBabADf39a3F22A8CC3AEE43765",
    },
  }),
  get(ChainId.LIGHTLINK, {
    core: {
      ...
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0x17c4f98c40e69a6A0D5c42B11E3733f076A99E20",
  ...
  get(ChainId.OP_MAINNET, {
    core: {
      ...
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0xd6920c1094eABC4b71f3dC411A1566f64f4c206e",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0x4b45090152a5731b5bc71b5baF71E60e05B33867",
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_MERKLE_STREAMER_FACTORY]: "0x044EC80FbeC40f0eE7E7b3856828170971796C19",
    },
  }),
  get(ChainId.POLYGON, {
    core: {
      [manifest.core.SABLIER_V2_COMPTROLLER]: "0x9761692EDf10F5F2A69f0150e2fd50dcecf05F2E",
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0xB194c7278C627D52E440316b74C5F24FC70c1565",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0x5f0e1dea4A635976ef51eC2a2ED41490d1eBa003",
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_MERKLE_STREAMER_FACTORY]: "0xF4906225e783fb8977410BDBFb960caBed6C2EF4",
    },
  }),
  get(ChainId.SCROLL, {
    core: {
      [manifest.core.SABLIER_V2_COMPTROLLER]: "0x859708495E3B3c61Bbe19e6E3E1F41dE3A5C5C5b",
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0xAaff2D11f9e7Cd2A9cDC674931fAC0358a165995",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0x57e14AB4DAd920548899d86B54AD47Ea27F00987",
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_MERKLE_STREAMER_FACTORY]: "0xb3ade5463000E6c0D376e7d7570f372eBf98BDAf",
    },
  }),
  get(ChainId.ZK_SYNC_ERA, {
    core: {
      [manifest.core.SABLIER_V2_COMPTROLLER]: "0xD05bdb4cF6Be7D647c5FEcC7952660bdD82cE44C",
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0xE6c7324BEA8474209103e407779Eec600c07cF3F",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0x2FcA69fa0a318EFDf4c15eE8F13A873347a8A8D4",
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_MERKLE_STREAMER_FACTORY]: "0x46DE683D20c3575A0381fFd66C10Ab6836390140",
    },
  }),
];
...
export const testnets: Sablier.DeploymentLockupV1[] = [
  get(ChainId.ARBITRUM_SEPOLIA, {
    core: {
      ...
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0x8c8102b92B1f31cC304A085D490796f4DfdF7aF3",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0x483bdd560dE53DC20f72dC66ACdB622C5075de34",
  ...
  get(ChainId.BASE_SEPOLIA, {
    core: {
      ...
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0xF46d5fA9bFC964E8d06846c8739AEc69BC06344d",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0xbd7AAA2984c0a887E93c66baae222749883763d3",
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_MERKLE_STREAMER_FACTORY]: "0xf632521bbAb0dBC2bEf169865e6c8e285AFe0a42",
    },
  }),
  get(ChainId.BLAST_SEPOLIA, {
    core: {
      [manifest.core.SABLIER_V2_COMPTROLLER]: "0x9e216126115AFcdA9531232D3B735731905B4DC4",
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0x8aB55a8E046634D5AD87f64d65C1E96275e48712",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0xe31Ac61c7762930625D4700D7ea9282B7E57b816",
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_MERKLE_STREAMER_FACTORY]: "0x6F147f9A251A1F004A1d043b8E486aAb00A49cef",
    },
  }),
  get(ChainId.OP_SEPOLIA, {
    core: {
      [manifest.core.SABLIER_V2_COMPTROLLER]: "0x6587166c4F4E0b6203549463EbAB4dBeFA63fd8f",
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0xf9e4095C1dfC058B34135C5c48cae66a8D2b3Aa5",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0xe59D28bEF2D37E99b93E734ed1dDcFc4B9C1bf73",
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_MERKLE_STREAMER_FACTORY]: "0x9b6cC73522f22Ad3f2F8187e892A51b95f1A0E8a",
    },
  }),
  get(ChainId.ETHEREUM_SEPOLIA, {
    core: {
      [manifest.core.SABLIER_V2_COMPTROLLER]: "0x2006d43E65e66C5FF20254836E63947FA8bAaD68",
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0xc9940AD8F43aAD8e8f33A4D5dbBf0a8F7FF4429A",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0x7a43F8a888fa15e68C103E18b0439Eb1e98E4301",
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_MERKLE_STREAMER_FACTORY]: "0xBacC1d151A78eeD71D504f701c25E8739DC0262D",
    },
  }),
  get(ChainId.TAIKO_HEKLA, {
    ...
    periphery: {
      ...
      [manifest.periphery.SABLIER_V2_MERKLE_STREAMER_FACTORY]: "0x29a8d9F67608d77D0B4544A70FC2ab80BA5525f5",
    },
  }),
  get(ChainId.ZK_SYNC_SEPOLIA, {
    core: {
      [manifest.core.SABLIER_V2_COMPTROLLER]: "0xEB4570723ae207a0473D73B3c2B255b0D5Ec9f01",
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0xe101C69A6f9c071Ab79aEE0be56928565962F56d",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0xdFC6F5D327dcF5DB579eC1b47fb260F93e042409",
