...
const mainnets: Sablier.DeploymentLockupV1[] = [
  getDeploymentLockupV1(ChainId.ETHEREUM, {
    core: {
      ...
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0x39EFdC3dbB57B2388CcC4bb40aC4CB1226Bc9E44",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0xB10daee1FCF62243aE27776D7a92D39dC8740f95",
  ...
  getDeploymentLockupV1(ChainId.ARBITRUM_ONE, {
    core: {
      ...
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0xA9EfBEf1A35fF80041F567391bdc9813b2D50197",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0x197D655F3be03903fD25e7828c3534504bfe525e",
  ...
  getDeploymentLockupV1(ChainId.AVALANCHE, {
    core: {
      ...
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0x665d1C8337F1035cfBe13DD94bB669110b975f5F",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0x610346E9088AFA70D6B03e96A800B3267E75cA19",
  ...
  getDeploymentLockupV1(ChainId.BSC, {
    core: {
      ...
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0xF2f3feF2454DcA59ECA929D2D8cD2a8669Cc6214",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0x3FE4333f62A75c2a85C8211c6AeFd1b9Bfde6e51",
  ...
  getDeploymentLockupV1(ChainId.GNOSIS, {
    core: {
      ...
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0xeb148E4ec13aaA65328c0BA089a278138E9E53F9",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0x685E92c9cA2bB23f1B596d0a7D749c0603e88585",
  ...
  getDeploymentLockupV1(ChainId.OP_MAINNET, {
    core: {
  ...
  getDeploymentLockupV1(ChainId.POLYGON, {
    core: {
      [manifest.core.SABLIER_V2_COMPTROLLER]: "0x9761692EDf10F5F2A69f0150e2fd50dcecf05F2E",
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0x7313AdDb53f96a4f710D3b91645c62B434190725",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0x67422C3E36A908D5C3237e9cFfEB40bDE7060f6E",
  ...
  getDeploymentLockupV1(ChainId.SCROLL, {
    core: {
      [manifest.core.SABLIER_V2_COMPTROLLER]: "0x859708495E3B3c61Bbe19e6E3E1F41dE3A5C5C5b",
      [manifest.core.SABLIER_V2_LOCKUP_DYNAMIC]: "0xde6a30D851eFD0Fc2a9C922F294801Cfd5FCB3A1",
      [manifest.core.SABLIER_V2_LOCKUP_LINEAR]: "0x80640ca758615ee83801EC43452feEA09a202D33",
