...
export const mainnets: Sablier.DeploymentLockupV1[] = [
  get(ChainId.ETHEREUM, {
    ...
    periphery: {
      [names.periphery.SABLIER_V2_ARCHIVE]: "0x0Be20a8242B0781B6fd4d453e90DCC1CcF7DBcc6",
      [names.periphery.SABLIER_V2_PROXY_PLUGIN]: "0x9bdebF4F9adEB99387f46e4020FBf3dDa885D2b8",
      [names.periphery.SABLIER_V2_PROXY_TARGET]: "0x297b43aE44660cA7826ef92D8353324C018573Ef",
      [names.periphery.SABLIER_V2_PROXY_TARGET_APPROVE]: "0x638a7aC8315767cEAfc57a6f5e3559454347C3f6",
    },
  }),
  get(ChainId.ARBITRUM_ONE, {
    ...
    periphery: {
      [names.periphery.SABLIER_V2_ARCHIVE]: "0xDFa4512d07AbD4eb8Be570Cd79e2e6Fe21ff15C9",
      [names.periphery.SABLIER_V2_PROXY_PLUGIN]: "0x9aB73CA73c89AF0bdc69642aCeb23CC6A55A514C",
      [names.periphery.SABLIER_V2_PROXY_TARGET]: "0xB7185AcAF42C4966fFA3c81486d9ED9633aa4c13",
      [names.periphery.SABLIER_V2_PROXY_TARGET_APPROVE]: "0x90cc23dc3e12e80f27c05b8137b5f0d2b1edfa20",
    },
  }),
  get(ChainId.AVALANCHE, {
    ...
    periphery: {
      [names.periphery.SABLIER_V2_ARCHIVE]: "0x7b1ef644ce9a625537e9e0c3d7fef3be667e6159",
      [names.periphery.SABLIER_V2_PROXY_PLUGIN]: "0x17167A7e2763121e263B4331B700a1BF9113b387",
      [names.periphery.SABLIER_V2_PROXY_TARGET]: "0x48B4889cf5d6f8360050f9d7606505F1433120BC",
      [names.periphery.SABLIER_V2_PROXY_TARGET_APPROVE]: "0x817fE1364A9d57d1fB951945B53942234163Ef10",
    },
  }),
  get(ChainId.BASE, {
    core: {
  ...
  get(ChainId.BSC, {
    ...
    periphery: {
      [names.periphery.SABLIER_V2_ARCHIVE]: "0xeDe48EB173A869c0b27Cb98CC56d00BC391e5887",
      [names.periphery.SABLIER_V2_PROXY_PLUGIN]: "0xC43b2d8CedB71df30F45dFd9a21eC1E50A813bD6",
      [names.periphery.SABLIER_V2_PROXY_TARGET]: "0x135e78B8E17B1d189Af75FcfCC018ab2E6c7b879",
      [names.periphery.SABLIER_V2_PROXY_TARGET_APPROVE]: "0xc9bf2A6bD467A813908d836c1506efE61E465761",
    },
  }),
  get(ChainId.GNOSIS, {
    core: {
    ...
    periphery: {
      [names.periphery.SABLIER_V2_ARCHIVE]: "0xF4A6F47Da7c6b26b6Dd774671aABA48fb4bFE309",
      [names.periphery.SABLIER_V2_PROXY_PLUGIN]: "0xc84f0e95815A576171A19EB9E0fA55a217Ab1536",
      [names.periphery.SABLIER_V2_PROXY_TARGET]: "0x5B144C3B9C8cfd48297Aeb59B90a024Ef3fCcE92",
      [names.periphery.SABLIER_V2_PROXY_TARGET_APPROVE]: "0x89AfE038714e547C29Fa881029DD4B5CFB008454",
    },
  }),
  ...
  get(ChainId.POLYGON, {
    ...
    periphery: {
      [names.periphery.SABLIER_V2_ARCHIVE]: "0xA2f5B2e798e7ADd59d85d9b76645E6AC13fC4e1f",
      [names.periphery.SABLIER_V2_PROXY_PLUGIN]: "0xBe4cad0e99865CC62787Ecf029aD9DD4815d3d2e",
      [names.periphery.SABLIER_V2_PROXY_TARGET]: "0x576743075fc5F771bbC1376c3267A6185Af9D62B",
      [names.periphery.SABLIER_V2_PROXY_TARGET_APPROVE]: "0xccA6dd77bA2cfcccEdA01A82CB309e2A17901682",
    },
  }),
  get(ChainId.SCROLL, {
    core: {
    ...
    periphery: {
      [names.periphery.SABLIER_V2_ARCHIVE]: "0x94A18AC6e4B7d97E31f1587f6a666Dc5503086c3",
      [names.periphery.SABLIER_V2_PROXY_PLUGIN]: "0xED1591BD6038032a74D786A452A23536b3201490",
      [names.periphery.SABLIER_V2_PROXY_TARGET]: "0x91154fc80933D25793E6B4D7CE19fb51dE6794B7",
      [names.periphery.SABLIER_V2_PROXY_TARGET_APPROVE]: "0x71CeA9c4d15fed2E58785cE0C05165CE34313A74",
    },
  }),
];
...
export const testnets: Sablier.DeploymentLockupV1[] = [
  get(ChainId.ARBITRUM_SEPOLIA, {
    ...
    periphery: {
      [names.periphery.SABLIER_V2_ARCHIVE]: "0x2C8fA48361C7D48Dc21b27a3D549402Cf8AE16B0",
      [names.periphery.SABLIER_V2_PROXY_PLUGIN]: "0x7D310803c3824636bAff74e4f80e81ece167c440",
      [names.periphery.SABLIER_V2_PROXY_TARGET]: "0x396A3a169918A4C0B339ECf86C583f46D696254E",
    },
  }),
  get(ChainId.ETHEREUM_SEPOLIA, {
    ...
    periphery: {
      [names.periphery.SABLIER_V2_ARCHIVE]: "0x83495d8DF6221f566232e1353a6e7231A86C61fF",
