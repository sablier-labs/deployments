...
export const mainnets: Sablier.Deployment[] = [
  ...
  get(ChainId.SUPERSEED, {
    [manifest.SABLIER_MERKLE_FACTORY]: ["0x3df48bb93509D9a041C81F6670C37B1eEb3E154B", 5_920_254],
  }),
  get(ChainId.TAIKO, {
  ...
  get(ChainId.ULTRA, {
    [manifest.SABLIER_MERKLE_FACTORY]: ["0x5e73bb96493C10919204045fCdb639D35ad859f8", 4_858_613],
  }),
